...
const MarsPage = () => {
    ...
    const [selectPhoto, setSelectPhoto] = useState<IMarsPhoto | undefined>(undefined)
    ...
    return (
        <div>
            <Header />
            <SettingsMars totalSolCount={totalSolCount} setSol={setSol} setRoverName={setRoverName} />
            {
                !noPhoto ? <>
                    {loading ? <Loader /> :
                        <>
                            <MainMarsContainer marsPhoto={marsPhoto} setSelectPhoto={setSelectPhoto} setIsShown={setIsShown} />
            ...
            {selectPhoto && <Modal isShown={isShown} setIsShow={setIsShown}><img src={selectPhoto.img_src} alt="mars photo" /></Modal>}
        </div>
    )
};
